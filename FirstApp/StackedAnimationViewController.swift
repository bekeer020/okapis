//
//  StackedAnimationViewController.swift
//  FirstApp
//
...
class StackedAnimationViewController: UIViewController,UICollisionBehaviorDelegate {
    ...
    func addViewController (atOffset offset:CGFloat, dataForVC data:AnyObject?) -> UIView? {
        ...
        let sb = UIStoryboard(name: "MyTest", bundle: nil)
        let stackElementVC = sb.instantiateViewController(withIdentifier: "StackedElement") as! StackElementViewController
        ...
        if let view = stackElementVC.view {
            ...
            let panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(StackedAnimationViewController.handlePan(gestureRecognizer:)))
